...
{name:['Taman Teknologi','Tech Ecology Park'],world:5400,goal:5200,time:120,required:13,spawn:{x:70,y:368},
	...
	cans:[A(850,372),A(1950,372),A(3050,372),A(4150,372)],powerups:[PWU(860,155,'speed'),PWU(1950,145,'jump'),PWU(3070,140,'shield'),PWU(4190,140,'speed')],checkpoints:[C(540,580),C(1040,1080),C(1580,1620),C(2120,2160),C(2680,2720),C(3240,3280),C(3800,3840),C(4360,4400),C(4920,4980)]},
